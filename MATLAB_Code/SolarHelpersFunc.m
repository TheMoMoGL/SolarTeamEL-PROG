function SolarHelpersFunc = SolarHelpersFunc
    SolarHelpersFunc.DecimalHourToHourFomrat = @DecimalHourToHourFomrat;
    SolarHelpersFunc.DecimalMinuteToHourFormat = @DecimalMinuteToHourFormat;
    SolarHelpersFunc.CalculateDayOfYear = @CalculateDayOfYear;
    SolarHelpersFunc.CalculateEoT = @CalculateEoT;
    SolarHelpersFunc.CalculateTC = @CalculateTC;
    SolarHelpersFunc.CalculateLST = @CalculateLST;
    SolarHelpersFunc.CalculateLSTM = @CalculateLSTM;
    SolarHelpersFunc.CalculateSolarFluxConstants = @CalculateSolarFluxConstants;
    SolarHelpersFunc.CalculateInsolationIntensity = @CalculateInsolationIntensity;
    SolarHelpersFunc.CalculateInsolationIntensityBetweenTwoHours = @CalculateInsolationIntensityBetweenTwoHours;
    SolarHelpersFunc.CalculateDeclinationAngle = @CalculateDeclinationAngle;
    SolarHelpersFunc.CalculateHourAngle = @CalculateHourAngle;
    SolarHelpersFunc.CalculateSolarAltitudeAngle = @CalculateSolarAltitudeAngle;
    SolarHelpersFunc.CalculateZenithAngle = @CalculateZenithAngle;
    SolarHelpersFunc.CalculateAzimuthAngle = @CalculateAzimuthAngle;
    SolarHelpersFunc.CalculateDayAngles = @CalculateDayAngles;
    SolarHelpersFunc.CalculateAngleOfIncidence = @CalculateAngleOfIncidence;
    SolarHelpersFunc.CalculateCollectedSolarPower = @CalculateCollectedSolarPower;
    SolarHelpersFunc.CalculateLongitudeCorrection = @CalculateLongitudeCorrection;
    SolarHelpersFunc.CalculateSolarCorrection = @CalculateSolarCorrection;
    SolarHelpersFunc.CalculateSolarPowerInstantaneously = @CalculateSolarPowerInstantaneously;
    SolarHelpersFunc.CalculateInSolarPowerBetweenTwoHours = @CalculateInSolarPowerBetweenTwoHours;
end
